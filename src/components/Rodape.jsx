...
function Rodape(){
    const tooltipEmail = <Tooltip id='tooltipEmail'><span>suporte@lansip.com.br <hr/> Clique para copiar!</span></Tooltip>
    ...
    return (
        ...
        <div>
            <Row className='rodape rodapeText'>
                {/* GRANDE */}
                <Col xs={3} xxl={3} className='grande d-flex justify-content-center align-items-center'>
                ...
                <Col xs={4} xxl={3} className='grande d-flex flex-column justify-content'>
                    
                    <a href='https://www.facebook.com/lansiptecnologia/' title='Facebook' target='_blank' rel="noreferrer" className='text-decoration-none text-reset'>
                        <FaFacebookSquare size={25}/>{`  `}facebook.com/lansiptecnologia
                    </a>
                    <a href='https://wa.me/554133878777' target='_blank' rel="noreferrer" title='Whatsapp' className='text-decoration-none text-reset'>
                        <FaWhatsapp size={25}/>{`  `}(41) 3387-8777
                    </a> 
                </Col>
                ...
                <Col xs={4} xxl={3} className='grande d-flex flex-column justify-content'>
                    <OverlayTrigger trigger={['click', 'focus', 'hover']} placement='top' overlay={tooltipEmail}>
                        <span onClick={() => copyText('suporte@lansip.com.br')} className='cursorPointer'><FaEnvelope size={24}/>{`  `}suporte@lansip.com.br</span>
                    </OverlayTrigger>
                </Col>
                
                <Col xs={4} xxl={6} className='grande d-flex align-items-center justify-content-center textoAzulClaro'>
                    Copyright © 2023 LanSip Tecnologia.
                </Col>
               
                {/* GRANDE */}
                
                {/* PEQUENO */}
                <Col xs={12} sm={6} className='pequeno d-flex flex-column justify-content'>
                    <span className='w-100 text-center'><b>Contato</b></span>

                    <a href='https://www.facebook.com/lansiptecnologia/' title='Facebook' target='_blank' rel="noreferrer" className='text-decoration-none text-reset'>
                        <FaFacebookSquare size={24}/>{`  `}facebook.com/LanSipTecnologia
                    </a>
                    <a href='https://wa.me/554133878777' target='_blank' rel="noreferrer" title='Whatsapp' className='text-decoration-none text-reset'>
                        <FaWhatsapp size={24}/>{`  `}(41) 3387-8777
                    </a>

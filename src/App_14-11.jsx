...
function App(){
  ...
  return (
    ...
    <Container fluid>
		...
		<Row className='d-flex justify-content-center m-2'>
			<Col  xs={12} className='text-center m-5 p-2 textoTitulo'><h1 onClick={renderCardFonts}>Por que Escolher a LanSip Tecnologia ?</h1></Col>
			<Col xs={9} className='mb-2 pb-4'>
				<h5 className='textoTitulo justify' onClick={renderCardFonts}>Experiência Comprovada: Com anos de experiência no setor, construímos uma reputação sólida como líderes em telefonia VoIP e serviços em nuvem.

Inovação Contínua: Mantemo-nos à frente das tendências tecnológicas para oferecer a você as soluções mais inovadoras e eficazes.

Atendimento ao Cliente Excepcional: Nossa equipe de suporte técnico está sempre disponível para atender às suas necessidades e resolver qualquer problema que possa surgir.

Economia Real: Acreditamos que você não deve comprometer a qualidade pela economia. Oferecemos soluções de alta qualidade a preços competitivos.</h5>
			</Col>
			<Col xs={12} sm={6} lg={3} className={`m-2 rounded-4 p-4 fundoCard`}>
